...
- **GET /api/v1/firebase/topic?deactivatedSince=:ISOTimestamp**
...
- **GET /api/v1/firebase/topic/:id**
  - works the same as the autogenerated controller endpoint
- **POST /api/v1/firebase/topic**
  - works the same as the autogenerated controller endpoint
  - topic name must follow the pattern `/^[a-zA-Z0-9-_.~%]{1,900}$/`
- **PATCH /api/v1/firebase/topic/:id**
  - works the same as the autogenerated controller endpoint

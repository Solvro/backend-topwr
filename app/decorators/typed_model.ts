...
export function validateColumnDef(
  ...
  return (
    ...
    typeof meta === "object" &&
    // meta.declaredType
    "declaredType" in meta &&
    typeof meta.declaredType === "string" &&
    // meta.allowedValues is type == enum
    (meta.declaredType !== "enum" ||
      ("allowedValues" in meta && Array.isArray(meta.allowedValues))) &&
    // meta.validator
    "validator" in meta &&
    typeof meta.validator === "object" &&
    // meta.optional
    "optional" in meta &&
    typeof meta.optional === "boolean" &&
    // meta.autoGenerated
    "autoGenerated" in meta &&
    typeof meta.autoGenerated === "boolean"
  );
}

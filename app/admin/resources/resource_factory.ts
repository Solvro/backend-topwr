...
export interface ResourceInfo {
  ...
  targetedByModels?: OneToManyRelationDefinition[]; //if belongs to any models (is child of)
}
...
export class ResourceFactory {
  ...
  private static addRelationReferenceProperty(
    ...
    owners: OneToManyRelationDefinition[],
  ) {
    owners.forEach((owner) => {
      const relationKey = getOneToManyRelationForeignKey(
        childModel,
        owner.targetModelPlural_camelCase ??
          anyCaseToPlural_camelCase(owner.targetModel),
      );
      resource.options.properties[relationKey] = {
        reference:
          owner.targetModelPlural_snake_case ??
          anyCaseToPlural_snake_case(owner.targetModel),
      };
    });
  }

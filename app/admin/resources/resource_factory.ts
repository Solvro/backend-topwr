...
export interface OwnedRelationDefinition {
  ...
  relationDefinition:
    | OneToManyOwnedRelationDefinition
 ...
 */
export interface OneToManyOwnedRelationDefinition {
...
const isManyToMany = (
  relDef: OneToManyOwnedRelationDefinition | ManyToManyOwnedRelationDefinition,
...
export class ResourceFactory {
  ...
  private static addOwnedOneToManyRelation(
    ...
    relationDefinition: OneToManyOwnedRelationDefinition,
  ): OneToManyRelationOptions {
    return {
